...
LoginTest
    ...
    New Project DE
DefaultCheck
    textfield should contain    ${InputBox}    New Training
CloneDefaultCheck
...
ErrorMessage_NoInput
    ...
    element text should be  ${IM}  Enter training name.
ErrorMessage_TooShort

    Verify Short Name EN    a
    Verify Short Name EN    6
    Verify Short Name EN    _
HappyPart

    Verify Valid Name EN    abc
    Verify Valid Name EN    567
    Verify Valid Name EN    -_.
    Verify Valid Name EN    Deutschland Nürnberg
ErrorMessage_MinMax

    Verify Valid Name EN    a2
    Verify Valid Name EN    aaaaaaaaaaaaaaaaaaaaaaaaaaaaaa32
ErrorMessage_TooLong

    Verify Long Name EN     aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
    Verify Long Name EN     123456789101112131415161718192021
ErrorMessage_ValidSpecialChar

    Verify Valid Name EN    --
    Verify Valid Name EN    __
    Verify Valid Name EN    ..
    Verify Valid Name EN    1Convit Xoera caiCanh
...
CloneChangeCheck
    ...
    run keyword and continue on failure    Verify Change Name of Clone EN      Name Change
DeleteProject
    Delete Project DE
    close all browsers
